...
tab1.push(238, 222, 228, 216, 200);

// 8) Afficher *un par un* tous les éléments du tableau tab1.

console.log(tab1[0],tab1[1],tab1[2],tab1[3],tab1[4],tab1[5],tab1[6],tab1[7],tab1[8],tab1[9],tab1[10],tab1[11]);
...
let maVariable = tab1[11];

for (let i = 0; i < tab1.length; i++) {
    if (tab1[i] > maVariable) {
        maVariable = tab1[i];
    }
}
